...
export function SignUp() {
  ...
  return login ? (
    ...
    <div className="signup">
      <h2>SIGN-UP</h2>
      <br />
      <h4>sign up to watch amazing videos</h4>
      <br />
      <form
        onSubmit={(e) =>
          signUpHandler(
      ...
      >
        <div>
          ...
          <div className="input-error-div">
            ...
            />
            <span
              style={{ display: errorState.fname ? "flex" : "none" }}
              className="error-msg"
            >
              <svg width="1.2em" height="1.2em" viewBox="0 0 24 24">
                <path
                  d="M12 2a7 7 0 0 1 7 7c0 5.25-7 13-7 13S5 14.25 5 9a7 7 0 0 1 7-7m0 2a5 5 0 0 0-5 5c0 1 0 3 5 9.71C17 12 17 10 17 9a5 5 0 0 0-5-5m-1 2h2v5h-2V6m0 7h2v2h-2v-2z"
                  fill="currentColor"
                ></path>
              </svg>
              {errorState.fname}
        ...
        <div>
          ...
          <div className="input-error-div">
            ...
            />
            <span
              style={{ display: errorState.lname ? "flex" : "none" }}
              className="error-msg"
            >
              <svg width="1.2em" height="1.2em" viewBox="0 0 24 24">
                <path
        ...
        <div>
          ...
          <div className="input-error-div">
            ...
            />
            <span
              style={{ display: errorState.emailId ? "flex" : "none" }}
              className="error-msg"
            >
              <svg width="1.2em" height="1.2em" viewBox="0 0 24 24">
                <path
        ...
        <div>
          ...
          <div className="input-error-div">
            ...
            <span
              style={{ display: errorState.password ? "flex" : "none" }}
              className="error-msg"
            >
              <svg width="1.2em" height="1.2em" viewBox="0 0 24 24">
                <path
        ...
        <div>
          ...
          <div className="input-error-div">
            ...
            <Mask mask={mask} setMask={setMask} />
            <span
              style={{ display: errorState.confirmPassword ? "flex" : "none" }}
              className="error-msg"
            >
              <svg width="1.2em" height="1.2em" viewBox="0 0 24 24">
                <path
