...
import {
  findCurrentVideo,
  likeUnlikeVideo
} from "../axios/axios.serverRequest";
    ...
    <>
      {videoPlayingNow !== null && (
        <div className="media-player-body">
          {playlistContainer && (
            <CreateNewPlaylist
              setPlaylistContainer={setPlaylistContainer}
              videoPlayingNow={videoPlayingNow}
            />
          )}
          <div className="media-player">
            ...
            <div className="media-details">
              ...
              <div
                className="media-like-unlike"
                onClick={() => likeUnlikeVideo(videoPlayingNow._id, dispatch)}
              >
                {likedVideos?.some(({ video }) => video.id === videoId) ? (
                  <svg
                    stroke="currentColor"
                    fill="red"
              ...
              <div
                className="media-watch-later"
                onClick={() => setPlaylistContainer((flag) => !flag)}
              >
                <svg width="1.4em" height="1.5em" viewBox="0 0 24 24">
                  <path
                    d="M6 4h10.586L20 7.414V18a3 3 0 0 1-3 3H6a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3zm0 1a2 2 0 0 0-2 2v11a2 2 0 0 0 2 2h11a2 2 0 0 0 2-2V7.914L16.086 5H15v5H6V5zm1 0v4h7V5H7zm5 7a3 3 0 1 1 0 6a3 3 0 0 1 0-6zm0 1a2 2 0 1 0 0 4a2 2 0 0 0 0-4z"
                    fill="currentColor"
                  ></path>
                </svg>
                <label>Save</label>
